...
/// Enumeration of story chapters with Bangla titles.
///
/// Each chapter value has a [title] getter that returns a human‑readable
/// Bangla title for the chapter.
enum ChapterId {
  chapter1,
  chapter2,
  chapter3,
  ...
  /// Returns the Bangla title for the chapter.
  String get title {
    return switch (this) {
